export enum Icons {
  ...
  add = `<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'> <path fill='#1DC7A5' fill-rule='evenodd' d='M20 12h-7v7h-1v-7H5v-1h7V4h1v7h7z'/> </svg>`,
  // @ts-ignore
  addNormal = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
